...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/shakboss/VIP-ScriptMultiPort/main/ssh/newudpgw"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/shakboss/VIP-ScriptMultiPort/main/issue.net"
