...
Exp=$(curl -sS https://raw.githubusercontent.com/shakboss/VIP-ScriptMultiPort/main/access | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/shakboss/VIP-ScriptMultiPort/main/version)
