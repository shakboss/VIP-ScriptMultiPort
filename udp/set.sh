...
if [ "$(lsb_release -rs)" = "8*|9*|10*|11*|16.04*|18.04*" ]; then
 ...
 # [+get files ⇣⇣⇣+]
  ...
  wget -O /etc/UDPCustom/module 'https://raw.githubusercontent.com/FasterExE/VIP-ScriptMultiPort/main/udp/module/module' &>/dev/null
  ...
  wget -O /etc/udp-custom.service 'https://raw.githubusercontent.com/FasterExE/VIP-ScriptMultiPort/main/udp/config/udp-custom.service'
